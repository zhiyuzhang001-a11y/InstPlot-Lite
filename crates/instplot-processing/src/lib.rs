...
mod tests {
    use super::{
        Anchor, ProcessingError, ProcessingMetadata, center_values, denoise_values, fit_polynomial,
        local_flatten_values, normalize_values, remove_polynomial_background,
    };
